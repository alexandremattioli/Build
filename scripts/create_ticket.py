...
if len(sys.argv) < 2:
    print("Usage: create_ticket.py <summary> [description] [issue_type]")
    print("Example: create_ticket.py 'Implement feature X' 'Details here' Task")
    sys.exit(1)
...
summary = sys.argv[1]
description = sys.argv[2] if len(sys.argv) > 2 else "Created via API"
